 ...
 */
/***************************************************************************/
const Error *CanOpen::SetNodeGuard( Node *n, GuardProtocol type, Timeout to, uint8 life, Timeout heartbeatPeriod )
{
   ...
   switch( type )
   {
      ...
      case GUARDTYPE_HEARTBEAT:
         ...
         if (heartbeatPeriod > 65535) { heartbeatPeriod = 65535; }
         err = n->sdo.Dnld16( 0x1017, 0, (uint16)heartbeatPeriod );
         if (err) { return err; }
         break;
