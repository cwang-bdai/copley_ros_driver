...
/***************************************************************************/
/**
Get the amplifier's load encoder type.

@param value A value that will hold the load encoder type retrieved from the drive.
@return A pointer to an error object, or NULL on success
*/
/***************************************************************************/
const Error* Amp::GetLoadEncoderType( uint16& value ) {
    const Error* err = 0;

    err = Upld16(OBJID_MOTOR_DATA, 30, value);
...
/***************************************************************************/
/**
Get the amplifier's miscellaneous options register.

@param value A value that will hold the miscellaneous options register retrieved from the drive.
@return A pointer to an error object, or NULL on success
*/
/***************************************************************************/
const Error* Amp::GetMiscellaneousOptions( uint32& value ) {
    const Error* err = 0;

    err = Upld32(OBJID_MISC_OPTIONS, 0, value);
