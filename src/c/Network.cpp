...
/// @return A string describing the passed state
const char *Network::DescribeState( NodeState state )
{
   switch( state )
   {
      case NODESTATE_UNKNOWN:     return "unknown";
      case NODESTATE_GUARDERR:    return "guard error";
      case NODESTATE_STOPPED:     return "init";
      case NODESTATE_PRE_OP:      return "pre-op";
      case NODESTATE_OPERATIONAL: return "operational";
      case NODESTATE_SAFE_OP:     return "safe op";
      case NODESTATE_BOOT:        return "boot";
