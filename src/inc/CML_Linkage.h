...
enum LINK_EVENT
{
   ...
   LINKEVENT_QUICKSTOP     = 0x00004000,
    ...
    /// One or more amplifier is trying to stop the motor.
...
private:
   ...
   class AmpTrj: public Trajectory
   {
      ...
      bool inUse;
      uunit ampTrjPositionArray[ CML_LINKAGE_TRJ_BUFFER_SIZE ];
      uunit ampTrjVelocityArray[ CML_LINKAGE_TRJ_BUFFER_SIZE ];
      uint8 ampTrjTimeArray[ CML_LINKAGE_TRJ_BUFFER_SIZE ];
      bool  useVelArray[ CML_LINKAGE_TRJ_BUFFER_SIZE ];
   ...
   void UpdateLoadToUserUnitConverters( void );
   const Error *UpdatePositionWrap(void);
