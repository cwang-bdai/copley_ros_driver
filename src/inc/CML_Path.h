...
public:
   ...
   static const PathError BadDimensions;  ///< Attempt to use a point with bad dimensions
   static const PathError BadCenterPoint; ///< The center point must result in a positive radius
   static const PathError NonPositiveRadius;     ///< The user entered a radius that is not a positive value
